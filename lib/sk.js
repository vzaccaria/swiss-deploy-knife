...
(function(){
  var _, moment, fs, color, os, shelljs, table, __q, winston, invokeActions, ref$, mountTunnel, unmountTunnel, printEnv, getInterestedNodes, getBaseConfigPath, dispOk, dispKo, disp, pdisp, pdeb, psetup, name, description, author, year, src, otm, cwd, usageString, optimist, argv, ff, nodes, namespace, e, ns, value, n, v, ok, ko, copy, original, current, i$, len$;
