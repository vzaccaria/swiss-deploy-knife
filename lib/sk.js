(function(){
  var _, moment, fs, color, os, shelljs, table, name, description, author, year, src, otm, cwd, setupTemporaryDirectory, usageString, optimist, argv, ff, ref$, nodes, namespace, tab, nsf, tf, ns, nns, vns, k, v, data, __q, invokeActions, ok, ko, original, current, i$, len$, n;
