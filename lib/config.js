...
(function(){
  var ref$, namespace, task, buildTasks, run, runLocal, runLocalSafe, createLocal, removeLocal, zsh, bsh, sequence, printAsTable, get, put, openTerminal, save, mirror, append, createLezione, createEsercitazione, createComunicazione, fail, shelljs, saveRemotely, copy, mzsh, czsh, home, sshCred, setupUbuntuDocker, nodes, localBinDir, ns;
  ...
  czsh = function(c){
    return "zsh -c 'source github/shellinit/common.zshrc && " + c + "'";
  };
  ...
  ns = buildTasks([
    ...
    }), task('test-jm', function(){
      var this$ = this;
      return runLocalSafe(this.remote, './scripts/jm-test', {
        subDir: 'infoweb',
        silent: true
      }).then(function(it){
        return append(it, {
          to: "w1:data/iwtest-jm.json",
          'in': this$.nodes,
          first: 5
        });
      });
