(function(){
  var debug, fn, ref$, namespace, task, buildTasks, run, bsh, sequence, printAsTable, get, put, openTerminal, save, nodes, x, s, f, localBinDir, b, ns;
  debug = false;
  fn = 'swiss-deploy-knife';
  if (debug) {
    fn = __dirname + "/../index.js";
  }
  ref$ = require(fn), namespace = ref$.namespace, task = ref$.task, buildTasks = ref$.buildTasks, run = ref$.run, bsh = ref$.bsh, sequence = ref$.sequence;
