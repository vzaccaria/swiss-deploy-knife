...
(function(){
  var _, moment, fs, color, ref$, spawn, kill, __q, sh, os, shelljs, cl, ut, winston, additionalSshParameters, dispOk, dispKo, disp, pdisp, pdeb, _module;
  ...
  additionalSshParameters = require('./ssh').additionalSshParameters;
  dispOk = function(){
  ...
  _module = function(){
    ...
    createTunnel = function(address, through){
      ...
      if (through == null) {
        ...
        if (through.port !== 22) {
          args = args.concat(["-p", through.port + ""]);
        }
